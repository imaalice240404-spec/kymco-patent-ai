...
if 'rd_database' not in st.session_state:
    st.session_state.rd_database = [] # 🌟 存放 Tab 3 的 RD 彈藥庫資料
...
with main_tab2:
    ...
    uploaded_excel = st.file_uploader("請上傳從 TWPAT 匯出的 Excel (請確保包含『摘要』與『申請專利範圍』)", type=["xlsx", "xls", "csv"], key="excel_upload_tab2")
